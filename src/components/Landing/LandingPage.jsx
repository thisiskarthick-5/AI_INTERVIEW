...
const Navbar = ({ onGetStarted }) => (
  <nav className="fixed w-full z-[100] flex justify-between items-center px-10 py-8 mix-blend-difference">
    ...
    <button onClick={onGetStarted} className="bg-white text-black px-8 py-3 rounded-full text-xs font-bold uppercase hover:bg-orange-500 transition cursor-pointer">Get Started</button>
  </nav>
);
